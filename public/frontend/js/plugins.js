...
!function (t, e) {
    ...
    t.fn.share = function (i) {
        var r = {
            ...
            networkDefs: {
                facebook: {url: "https://www.facebook.com/trimatric.architects/"},
...
!function (t) {
    ...
    t.fn.fitText = function (n, e) {
        var i = n || 1, r = t.extend({minFontSize: Number.NEGATIVE_INFINITY, maxFontSize: Number.POSITIVE_INFINITY}, e);
        return this.each(function () {
            var n = t(this), e = function () {
...
!function (t, e, o) {
    ...
    }, t.HoverDir.defaults = {speed: 300, easing: "ease", hoverDelay: 0, inverse: !1}, t.HoverDir.prototype = {
        _init: function (e) {
            ...
            this.$el.on("mouseenter.hoverdir, mouseleave.hoverdir", function (o) {
                var i = t(this), n = i.find("div.hd-box"), s = e._getDir(i, {x: o.pageX, y: o.pageY}),
                    r = e._getStyle(s);
            ...
            var o = t.width(), i = t.height(), n = (e.x - t.offset().left - o / 2) * (o > i ? i / o : 1),
                s = (e.y - t.offset().top - i / 2) * (i > o ? o / i : 1),
                r = Math.round((Math.atan2(s, n) * (180 / Math.PI) + 180) / 90 + 3) % 4;
            return r
        }, _getStyle: function (t) {
            var e, o, i = {left: "0px", top: "-100%"}, n = {left: "0px", top: "100%"}, s = {left: "-100%", top: "0px"},
...
!function (e, t, a) {
    ...
    a[e] = {
        ...
        settings: {
            ...
            loadError: function (t) {
                var s = this.settings.createPlayer, n = r(s.errorMessageClass, this.wrapper);
            ...
            loadStarted: function () {
                var t = this.settings.createPlayer, s = r(t.durationClass, this.wrapper),
                    n = Math.floor(this.duration / 60), i = Math.floor(this.duration % 60);
            ...
            updatePlayhead: function (e) {
                ...
                var s = r(t.playedClass, this.wrapper), n = this.duration * e, i = Math.floor(n / 60),
                    l = Math.floor(n % 60);
        ...
        newInstance: function (e, s) {
            e = e;
            var n = this.helpers.clone(this.settings), r = "audiojs" + this.instanceCount,
        ...
        createPlayer: function (e, t, a) {
            var s = document.createElement("div"), n = e.cloneNode(!0);
        ...
        attachEvents: function (t, s) {
            if (s.settings.createPlayer) {
                var n = s.settings.createPlayer, i = r(n.playPauseClass, t), l = r(n.scrubberClass, t);
        ...
        injectFlash: function (e, t) {
            ...
            var s = e.wrapper.innerHTML, n = document.createElement("div");
        ...
        helpers: {
            merge: function (e, t) {
                ...
                var o = document.getElementsByTagName("head")[0], d = o.firstChild, p = document.createElement("style");
        ...
        events: {
            memoryLeaking: !1, listeners: [], addListener: function (t, s, n) {
                t.addEventListener ? t.addEventListener(s, n, !1) : t.attachEvent && (this.listeners.push(t), this.memoryLeaking || (window.attachEvent("onunload", function () {
                    if (this.listeners) for (var t = 0, s = this.listeners.length; t < s; t++) a[e].events.purge(this.listeners[t])
                ...
                var t = window, a = !1, s = !0, n = t.document, r = n.documentElement,
                    i = n.addEventListener ? "addEventListener" : "attachEvent",
                    l = n.addEventListener ? "removeEventListener" : "detachEvent", o = n.addEventListener ? "" : "on",
                    d = function (s) {
    ...
    var r = function (e, t) {
        var a = [];
        if ((t = t || document).getElementsByClassName) a = t.getElementsByClassName(e); else {
